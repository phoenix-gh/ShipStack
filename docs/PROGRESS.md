...
| Module Chinese docs exist                              | Passing | Database/auth/billing/storage smoke checks generated module docs.      |
| Module docs are linked from generated README           | Passing | CLI, billing/storage smoke, and pack check verify README module links. |
